...
const defaultContent: NicheContent = {
  ...
  heroSubtitle: "Oferecemos o melhor atendimento com profissionais qualificados e dedicados ao seu bem-estar.",
  aboutLabel: "Sobre nós",
  ...
  reviews: [
    { name: "Maria L.", text: "Atendimento excepcional! Superou todas as minhas expectativas.", rating: 5 },
    { name: "João P.", text: "Profissionais incríveis e resultado impecável.", rating: 5 },
    { name: "Carla S.", text: "Recomendo para todos! Qualidade incomparável.", rating: 5 },
  ],
